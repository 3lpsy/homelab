...
variable "container_port" {
  description = "TCP port the MCP server listens on (passed as MCP_PORT, exposed as containerPort, Service port + targetPort, and probed for /healthz). Default 8000 matches FastMCP's default."
  type        = number
  default     = 8000
}
