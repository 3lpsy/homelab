// CARGO_BIN_EXE_* is only set inside the bin-owning crate. Test helpers
// duplicated across crates rather than abstracting into a shared dev-dep.
...
pub fn extract_text(v: &serde_json::Value) -> String {
